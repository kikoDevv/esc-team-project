...
async function openBookingPageTwo(ID, minParticipants, maxParticipants, date) {
  ...
  section.innerHTML = `
      <form class ="container-form">
         ...
         <label for="input-phone-number">Phone number (123-456-7890)</label>
         <input id="input-phone-number" name="input-phone-number" type="tel" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}">
  ...
  submitBtn.addEventListener("click", (event) => {
    ...
    const bookedNumber = document.querySelector("#input-phone-number").value;
